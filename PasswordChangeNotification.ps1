...
foreach ($user in $notifyUsers)
{
    ...
    # Subject Setting
    $subject="您的密碼將於 $messageDays 天後到期"
    ...
    <p> $subject<br>
    <p>請立即更新您的密碼</p>
    <p>要在PC上更改密碼，請按CTRL ALT DEL 並選擇更改密碼</p>
    <p>也可以通過Web Mail更改密碼。</p>
    <p>登入Web Mail，單擊「選項」->「一般」->「我的帳戸」，然後點擊「更改密碼」。</p>
    <p>不要忘記更新移動設備上的密碼！</p>
    <p> 謝謝</p>
    <br>
    IT 資訊課
    <a href=""mailto:support@artc.org.tw""?Subject=密碼到期協助"">support@artc.org.tw</a>
    </font>"
